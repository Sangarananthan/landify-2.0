...
import SampStyle from "../../SampStyle";
const Hero = () => {
  return (
    <div className="relative px-4 lg:px-28 md:px-16 bg-[#ffffff] pt-12 flex flex-col lg:flex-row md:flew-row items-center font-inter justify-between pb-3 lg:pb-24">
      <SampStyle />
      <div className="relative z-10 text-start w-full lg:w-1/2">
        ...
        <div className="flex flex-row gap-7 font-medium">
          ...
          <button className="flex items-center bg-[#ece2ff] text-[#7C3AED] py-2 px-4 rounded-md">
